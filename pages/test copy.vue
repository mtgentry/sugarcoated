<template lang="pug">
  v-row#main.flex-column.justify-center.align-center
    v-col(cols="12" class="content-column")
      .copy-container
        h1 Amazing Product Photos Without a Studio
        p.intro Using 3D rendering, Saint Jane changed how they make product photos. They no longer need to build real prototypes, rent studios, or use expensive gear. This cuts costs and makes changes easy, so there's no need for pricey reshoots.
        ...
        .image-container
          .image-with-caption
            img(src="/images/final.jpg" alt="Final" class="mason-image")
            .image-caption Lorem Epsom
        ...
        .images-container.side-by-side
          .image-with-caption
            img(src="/images/first.jpg" alt="First environment")
            .image-caption First environment caption
          .image-with-caption
            img(src="/images/second.jpg" alt="Second environment")
            .image-caption Second environment caption
        p Below are two images in the same setting with tweaks made to match the brand.
        .image-container
          .image-with-caption
        ...
        .images-container.full-width
          .image-with-caption
            img(src="/images/double.png" alt="Jar measurement 1" class="double")
